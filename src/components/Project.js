...
const Project = () => {
  const [header] = React.useState({
    ...
    text:
      `If you want look my practice project code click  'Go Link'.`,
  });
  const [state] = React.useState([
...

    {
      ...
      text:
      <a target="_blank" rel="noopener noreferrer" href="https://github.com/binodpoudel/react-portfolio-page"><button type="button" className="btn btn-info">Go Link</button></a>
    }
